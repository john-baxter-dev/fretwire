...
meter says 72.7%; the pedal refuses swaps as though it were full, and a ladder of hardware probes
puts the real ceiling near 75% on our scale. If HX Edit reads ~97% for that preset, the scale factor
is confirmed in thirty seconds and we can fix the meter instead of documenting a magic number.
**Right now the tool tells people they have headroom they do not have** — this is the highest
value-per-second item in the whole document.
